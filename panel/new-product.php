 ...
 <div class="col-lg-12">
	...
	<div class="card">
	  ...
	  <div class="card-body card-block">
		...
		<div class="form-group"><label for="company" class=" form-control-label">Ürün Başlığı</label><input type="text" id="company" placeholder="Ürün Başlığı" class="form-control"></div>
